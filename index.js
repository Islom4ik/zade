...
news.action('newssend', async ctx => {
    try {
        ...
        for (let i = 0; i < admdb.users.length; i++) {
            setTimeout(async () => {
                try {
                    const msg = await ctx.tg.copyMessage(admdb.users[i], ctx.chat.id, admdb.msgid)
                    await ctx.tg.deleteMessage(admdb.users[i], msg.message_id)
                } catch (e) {
                    console.log('Err news sending');
                }
            }, 500);
        }
...
bfg.enter(async ctx => {
    try {
        return await ctx.reply('👨🏻‍💻 Enter sequence (AaBBCCDd):', {reply_markup: {keyboard: [['EXIT BRUTEFORCER 🔴']],resize_keyboard: true}})
    } catch (e) {
        console.error(e);
    }
})
...
let filesdassessments = ['BQACAgIAAxkBAAILr2RwiDw_QRDN4dXJsOPObrxgJtupAAI6KwACX7eBS1UNByb-oIJSLwQ','BQACAgIAAxkBAAILsGRwiFodCQ6u-W943kih_aJ6gPOvAAIxKwACX7eBS9nVZ99AYdnVLwQ','BQACAgIAAxkBAAILsWRwiHJg1xe2Bh9GTbz47OnFAAEnEwACMisAAl-3gUvNwt3EHEw_ii8E','BQACAgIAAxkBAAILsmRwiIS1nxKego_VuaSwmy0tiYtjAAIzKwACX7eBS8cs1K-Ady1OLwQ','BQACAgIAAxkBAAILs2RwiKroVy3lZo4bojCqQRP6nAhAAAI0KwACX7eBS7f4q906BLGbLwQ','BQACAgIAAxkBAAILtGRwiL-y2Xbxk1ZdUkCArjbqk1UKAAI1KwACX7eBS7Z0O-9JMuoVLwQ','BQACAgIAAxkBAAILtWRwiNylTSQEBmzKAWUFHMSvV0RzAAI2KwACX7eBS2s1h3u7dC8_LwQ','BQACAgIAAxkBAAILtmRwiOywUMPer8p8zRmPpQTc5IzqAAI3KwACX7eBS-O8MNChcpiYLwQ','BQACAgIAAxkBAAILt2RwiPqegWHYKIeDUHYxnXiyTkAsAAI4KwACX7eBS6o9Gd_BPSTELwQ','BQACAgIAAxkBAAILuGRwiQj3l1JAATEdY7JORayMvlCaAAI5KwACX7eBS7RZVG-5kT69LwQ','BQACAgIAAxkBAAINLWR4ZSfW5xqjPUB2wR1VF3PPhC6aAALXKQACTs3BS-iM4pJQMXpXLwQ','BQACAgIAAxkBAAINLmR4ZYPCuDbvT6djBf7q0v0Kb734AALZKQACTs3BS4TmVkhrLJXKLwQ']

bot.start(async (ctx) => {
    try {
        if(ctx.startPayload != '') {
            let usindb = await collection.findOne({user_id: ctx.from.id})
            if (usindb == null) return await ctx.reply('Access is denied 🔒')
            if (usindb.gr == 1 || usindb.gr == 2) {
                let documentid = await ctx.startPayload.split('_')[1]
                await ctx.replyWithDocument(filesdassessments[documentid-1], {protect_content: true})
            }else {
                return await ctx.reply('Access is denied 🔒')
            }
        }else {
...
//     }
// }, 3000);
const bio = [{type: 'document', id: '1', title: 'Cell Membrane', description: 'Cell Membrane lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK92RieUa1XiIR2uNzwF50q9ej_sqaAAK2MQACwCcZS5C41aWA0XgJLwQ'}, {type: 'document', id: '2', title: 'Meyosis and Mitosis', description: 'Meyosis and Mitosis lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK-GRieY8jawvINczc04FIAkiVlZF2AAK5MQACwCcZS8vduyWN7u7pLwQ'}, {type: 'document', id: '3', title: 'Photosynthesis', description: 'Photosynthesis lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK-WRiee7DTEMsyymLMu5saBRScff8AAK8MQACwCcZSynJfQtTd6W-LwQ'}, {type: 'document', id: '4', title: 'The Plants', description: 'Plants lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK-mRieizXkDbu1nOk4hYC-l2W61WOAAK9MQACwCcZS9YAAdaPNI2LRC8E'}, {type: 'document', id: '5', title: 'Transcription and Translation', description: 'Transcription and Translation lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK-2RiemLbFBCwTUqZI8DLUe1amxnCAAK-MQACwCcZSxaU9BCBK44QLwQ'}, {type: 'document', id: '6', title: 'Bacterias', description: 'Bacterias lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK_GRieqwpJIOJtBDPpK61XgLQ9Ko6AAK_MQACwCcZS9OevU1bbgAB0C8E'}, {type: 'document', id: '7', title: 'Cell structure', description: 'Cell structure lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK_WRietguz1vP-FbFLr-PGxiFxrvgAALBMQACwCcZS4j_9Pg6QWCvLwQ'}, {type: 'document', id: '8', title: 'Cellular resperation', description: 'Cellular resperation lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK_mRiewwc2v_Uqx7acWaKXIvqMyKqAALDMQACwCcZS14Skd_rRxBsLwQ'}, {type: 'document', id: '9', title: 'Endocrine system', description: 'Endocrine system lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK_2Rie2A-VXb3ERIMoeozB1SZssmrAALFMQACwCcZS_PkJ4-2FXOPLwQ'}]

const anatomy = [{type: 'document', id: '1', title: 'Male Reproductive System', description: 'Male Reproductive System lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK3mRicq201czl61h20W8ZD90ji9poAALoJwACWjqpSuzR8piI6KpMLwQ'}, {type: 'document', id: '2', title: 'Female Reproductive System', description: 'Female Reproductive System lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK32RiczlLeVozv8IGRyvQqdn4TOgxAALnJwACWjqpStPNtSw1lf3fLwQ'}, {type: 'document', id: '3', title: 'Musculoskeletal System', description: 'Musculoskeletal System lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK4WRidQljvL98IPSNBLRsbLpHgoz8AALmJwACWjqpSoUpAAHqJVvtdi8E'}, {type: 'document', id: '4', title: 'Endocrine System', description: 'Endocrine System lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK4mRidfIY15MRzQ3dk0TfDvpsZHOHAALpJwACWjqpSrMrk5J8n3SZLwQ'}, {type: 'document', id: '5', title: 'Digestive System', description: 'Digestive System lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK42RidkGlmMahrSTCB2LZQUUWg24kAALqJwACWjqpSqpzbo2i4lFSLwQ'}, {type: 'document', id: '6', title: 'Cardiac System', description: 'Cardiac System lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK5GRidnhJzqYuMDR3qbXZbk1cTvcEAALsJwACWjqpSh-GZRr3rw9DLwQ'}, {type: 'document', id: '7', title: 'Urinary System', description: 'Urinary System lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK5WRiduWkyzohpwIwSGTFpOOlWi90AALtJwACWjqpSjXQOFSY5cj9LwQ'}, {type: 'document', id: '8', title: 'Skin', description: 'Skin lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK5mRidyHe5UaSuGUO5-8gbw0-9d7WAALwJwACWjqpSmmIKRZj1L7KLwQ'}, {type: 'document', id: '9', title: 'The heart', description: 'Heart lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK52Rid92z5hMh3aQ-TESWXYnU1_RGAALuJwACWjqpSje1iaSI-MhuLwQ'}, {type: 'document', id: '10', title: 'Nervous system', description: 'Nervous system lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK6GRieBwCZHAgfE2QcEPJr_M81pZoAAL0JwACWjqpSkLSNYWw7cG5LwQ'}, {type: 'document', id: '11', title: 'Neurulation', description: 'Neurulation lecture.', thumb_url: 'https://www.graphicsprings.com/filestorage/stencils/2f3bdb9733c4a68659dc2900a7595fea.png', document_file_id: 'BQACAgIAAxkBAAIK6WRieFeNdnH7pe-3sTNFz8-doB6ZAALzJwACWjqpSqYLJ_SZkQoqLwQ'}]

const phurl = 'https://cdn.discordapp.com/attachments/992866546596712638/1113732616110227456/Screenshot_2.png'


bot.on('inline_query', async ctx => {
    try {
        if(ctx.inlineQuery.query == 'biology' || ('biology'.includes(ctx.inlineQuery.query) && ctx.inlineQuery.query.length >= 2)) {
            await ctx.answerInlineQuery(bio, {cache_time: 1, is_personal: true})
        }else if(ctx.inlineQuery.query == 'anatomy' || ('anatomy'.includes(ctx.inlineQuery.query) && ctx.inlineQuery.query.length >= 2)) {
            await ctx.answerInlineQuery(anatomy, {cache_time: 1, is_personal: true})
        }else if(ctx.inlineQuery.query == 'assessments' || ('assessments'.includes(ctx.inlineQuery.query) && ctx.inlineQuery.query.length >= 2)) {
            await ctx.answerInlineQuery([{type: 'article', id: '1', title: 'Assessment 1', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_1`)]]}, input_message_content: {message_text: 'Assessment 1'}}, {type: 'article', id: '2', title: 'Assessment 2', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_2`)]]}, input_message_content: {message_text: 'Assessment 2'}}, {type: 'article', id: '3', title: 'Assessment 3', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_3`)]]}, input_message_content: {message_text: 'Assessment 3'}}, {type: 'article', id: '4', title: 'Assessment 4', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_4`)]]}, input_message_content: {message_text: 'Assessment 4'}}, {type: 'article', id: '5', title: 'Assessment 5', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_5`)]]}, input_message_content: {message_text: 'Assessment 5'}}, {type: 'article', id: '6', title: 'Assessment 6', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_6`)]]}, input_message_content: {message_text: 'Assessment 6'}, description: 'Genetics'}, {type: 'article', id: '7', title: 'Assessment 7', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_7`)]]}, input_message_content: {message_text: 'Assessment 7'}}, {type: 'article', id: '8', title: 'Assessment 8', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_8`)]]}, input_message_content: {message_text: 'Assessment 8'}}, {type: 'article', id: '9', title: 'Assessment 9', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_9`)]]}, input_message_content: {message_text: 'Assessment 9'}}, {type: 'article', id: '10', title: 'Assessment 10', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_10`)]]}, input_message_content: {message_text: 'Assessment 10'}}, {type: 'article', id: '11', title: 'Assessment 11', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_11`)]]}, input_message_content: {message_text: 'Assessment 11'}}, {type: 'article', id: '12', title: 'Assessment 12', thumb_url: phurl, reply_markup: {inline_keyboard: [[Markup.button.url('GET DOCUMENT 📩', `https://t.me/thisiszade_bot?start=${ctx.from.id}_12`)]]}, input_message_content: {message_text: 'Assessment 12'}}], {cache_time: 1, is_personal: true})
        }else {
            await ctx.answerInlineQuery([{type: 'article', id: '1', title: 'THIS IS ZADE', description: 'Hello Everyone', thumb_url: 'https://cdn.discordapp.com/attachments/992866546596712638/1113742971708391454/photo_2023-02-15_20-28-39.jpg', input_message_content: {message_text: 'ZADE\'s bot below ⬇️'}, reply_markup: {inline_keyboard: [[Markup.button.url('THIS IS ZADE\'s BOT 🤖', 'https://t.me/thisiszade_bot')]]}}], {cache_time: 1, is_personal: true})
        }
    } catch (e) {
        console.error(e);
    }
...
bot.on('forward_date', ctx => console.log(ctx.message.document.file_id + '\n----------------\n'))
